    ...
    <div>
        ...
        <div class="content">
            ...
            <br>
                ...
                <form name="addinquiries" method="post" action="AddInquiriesServlet">
                        
	                <table>
		
					<tr>
						<td>Contact Number :</td>
						<td> <input type = "text" name="contactnumber" class="input_style1"> </td>
					</tr>
					<tr>
						<td>Problem Description :</td>
						<td> <input type = "text" name="problemdescription" class="input_style1"> </td>
					<tr>
						<td>Priority :</td>
						<td> <input type = "text" name="priority" class="input_style1"> </td>
					</tr>
					
					<tr>
						<td>Technician :</td>
						<td> <input type = "text" name="empid" class="input_style1"> </td>
					</tr>
